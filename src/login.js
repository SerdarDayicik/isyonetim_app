      ...
      <div className="w-full md:w-1/2 p-8 md:p-16 border-l border-gray-800 bg-[#121212]">
        <div className="max-w-xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-8 mt-32">
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white py-4 px-6 rounded-xl hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-[#121212] text-lg font-medium"
            >
              Giriş Yap
            </button>
